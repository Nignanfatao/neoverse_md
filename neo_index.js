    ...
    try {
        zk.ev.on("messages.upsert", async (m) => {
            try {
                ...
                console.error("Une erreur est survenue lors du traitement du message:", error.message, error.stack);
            }
        });
    } catch (error) {
        console.error("Une erreur est survenue :", error.message, error.stack);
    }
};
