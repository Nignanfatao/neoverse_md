...
async function insertData() {
  ...
  try {
    for (let i = 1; i <= 12; i++) {
      const query = `
        INSERT INTO westdiv(e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11, e12, e13, e14, e15, e16, e17)
...
async function getData(ide) {
  ...
  try {
   const query = 'SELECT e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11, e12, e13, e14, e15, e16, e17 FROM westdiv WHERE id = $1';
